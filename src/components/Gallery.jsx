      ...
      <div className="gallery flex flex-wrap justify-center mt-10 max-sm:flex-col">
        {sede === "cuba"
          ? galleryData.sede1Media.map((item, index) => (
              ...
              >
                ...
                >
                  {item.type === "photo" ? (
                    <img className="rounded-lg shadow-lg" src={item.src} alt={item.alt} />
                  ) : (
        ...
        {selectedImage && (
         ...
         <div className="flex items-center justify-center h-full">
           <img src={selectedImage} alt="Gym evolution" className="max-w-full max-h-full" />
         </div>
         <button
           className="absolute top-4 right-4 text-white text-3xl hover:text-amarillo"
